...
module SwaggerClient
  ...
  class HLRCallback
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'extended')
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["valid", "invalid", "unknown"])
      return false unless status_validator.valid?(@status)
      duration_validator = EnumAttributeValidator.new('String', ["perm", "temp"])
    ...
    def duration=(duration)
      validator = EnumAttributeValidator.new('String', ["perm", "temp"])
    ...
    def hash
      [id, msisdn, status, country, operator, mccmnc, duration, message, extended, cost].hash
    end
